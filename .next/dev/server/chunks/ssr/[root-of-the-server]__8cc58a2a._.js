...
;
const metadata = {
    title: "Nuôi Tôi - Dự án thiện nguyện cho một cuộc sống tốt đẹp hơn",
    description: "Dự án thiện nguyện vui nhộn và chân thành. Hãy nuôi tôi để tôi có thể sống qua ngày với trà sữa, cơm tấm và niềm tin.",
    generator: "v0.app",
    icons: {
        icon: [
            {
